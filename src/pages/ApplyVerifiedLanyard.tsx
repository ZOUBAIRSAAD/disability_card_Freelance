...
import { verifiedLanyardApplicationAPI, CreateVerifiedLanyardApplicationRequest } from '../api/verifiedLanyardApplicationApi';
...
const ApplyVerifiedLanyard = () => {
  ...
  const confirmSubmission = async () => {
    try {
      ...
      const applicationData: CreateVerifiedLanyardApplicationRequest = {
        ...
        hasExistingCard: formData.hasExistingCard,
        cardImage: cardImage || undefined
      };

      const response = await verifiedLanyardApplicationAPI.createApplication(applicationData);
